...
public class TestGenerateChartServlet {
	...
	@Test
	public void testGenerateChartServletValidInput() throws Exception {
		...
		//when(dao.GenerateChart(anyInt(), anyString(), anyString(), anyString(), anyString(), anyString(), anyString(), anyDouble(), anyDouble(), anyDouble(), ALDeals)).thenReturn();
