...
function manipulate(){
	...
	//Event Location
	var labelDealSchedule  = document.createElement("label");
	labelDealSchedule .setAttribute("for", "dealSchedule"+globalDivCount);
	labelDealSchedule .innerHTML = "Location:";
	var textDealSchedule = document.createElement("input");
	textDealSchedule.setAttribute("type", "text");
	textDealSchedule.setAttribute("id", "dealSchedule"+globalDivCount);
	...
	element.appendChild(document.createElement("br"));
	element.appendChild(document.createElement("br"));*/
	element.appendChild(labelDealSchedule);
	element.appendChild(textDealSchedule);
	element.appendChild(document.createElement("br"));
...
function submit(){
	...
	for(var i=0;i<kids.length;i++){
		...
		var index=$(kids[i]).attr("index");//.id;
			...
			Ad.dealSchedule = document.getElementById("dealSchedule"+index).value;
			Ad.noofDeals = document.getElementById("noofDeals"+index).value;
			Ad.noofAttendees = 0;
			//Ad.scheduletime="00:00 - 24:00"; // Rohini commented out
